    ...
    <div class="max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Logo -->
                <div class="shrink-0 flex items-center ms-5">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('managemyprofile.index')">
                            {{ __('Profile') }}
                        </x-dropdown-link>
                ...
                <div class="flex items-center px-3 py-2">
                    <button id="theme-toggle" type="button" class="flex items-center px-3 py-2 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
