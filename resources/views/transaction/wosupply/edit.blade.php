...
<div class="py-8">
	<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
		<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('transactionwosupply.update',$wosupplies->wosuppliesid) }}" method="POST" class="p-4 md:p-5">
                    @csrf
                    @method('PATCH')   
                            ...
                            <div class="grid gap-4 mb-4 grid-cols-2">
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    <div class="form-group mt-4">
                                        <x-input-label for="suppliesdesc" :value="__('Supplies Description')" />
                                        <x-text-input id="suppliesdesc" name="suppliesdesc" class="block mt-1 w-full" type="text" :value="old('wosuppliesdesc',$wosupplies->wosuppliesdesc)" autofocus />
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    <div class="form-group mt-4">
                                        ...
                                        <x-text-input id="particulars" name="particulars" class="block mt-1 w-full" type="text" :value="old('particulars',$wosupplies->particulars)" autofocus />
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    <div class="form-group mt-4">
                                        ...
                                        <x-text-input id="qty" name="qty" class="block mt-1 w-full" type="number" :value="old('qty',$wosupplies->qty)" autofocus />
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    <div class="form-group mt-4">
                                        <x-input-label for="remarks" :value="__('Particulars')" />
                                        <x-text-input id="remarks" name="remarks" class="block mt-1 w-full" type="text" :value="old('remarks',$wosupplies->remarks)" autofocus />
