...
<div class="py-8">
	<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
		<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('manageworkclass.update',$workclass->workclassid) }}" method="POST" class="p-4 md:p-5">
                    @csrf
                    @method('PATCH')   
                    <div class="relative p-4 w-full max-w-full max-h-full">
                        ...
                        <nav class="flex px-5 py-3 text-gray-700 bg-white dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
                            <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                                ...
                                <a href="{{ route('manageworkclass.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-blue-600 dark:text-gray-400 dark:hover:text-white">
                            ...
                            <!-- Modal body -->
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    <div class="form-group mt-4">
                                        ...
                                        <x-text-input id="notes" class="block mt-1 w-full" type="text" name="notes" :value="old('notes',$workclass->notes)" autofocus />
