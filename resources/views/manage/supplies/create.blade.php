...
<div class="py-8">
	<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
		<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('managesupplies.store') }}" method="POST" class="p-4 md:p-5">
                    @csrf   
                            ...
                            <div class="grid gap-4 mb-4 grid-cols-2">
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    <div class="form-group mt-4">
                                        <x-input-label for="suppliesdesc" :value="__('Supplies Name')" />
                                        <x-text-input id="suppliesdesc" class="block mt-1 w-full" type="text" name="suppliesdesc" :value="old('suppliesdesc')" autofocus />
