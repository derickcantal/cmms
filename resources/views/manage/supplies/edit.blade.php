...
<div class="py-8">
	<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
		<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{ route('managesupplies.update',$supplies->suppliesid) }}" method="POST" class="p-4 md:p-5">
                    @csrf
                    @method('PATCH')   
                            ...
                            <!-- Modal body -->
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    <div class="form-group mt-4">
                                        ...
                                        <x-text-input id="supplies" class="block mt-1 w-full" type="text" name="supplies" :value="old('supplies',$supplies->suppliesdesc)" autofocus />
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    <div class="form-group mt-4">
                                        ...
                                        <x-text-input id="notes" class="block mt-1 w-full" type="text" name="notes" :value="old('notes',$supplies->notes)" autofocus />
