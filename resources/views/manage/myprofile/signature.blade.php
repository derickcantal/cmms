			...
			<div class="py-8">
				<div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
					<div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                        ...
                        <form action="{{ route('managemyprofile.savesignature',$user->userid) }}" method="POST" enctype="multipart/form-data" class="p-4 md:p-5">
                            @csrf
                            @method('PATCH')  
                            <div class="relative p-4 w-full max-w-full max-h-full">
                                ...
                                <div class="relative bg-white rounded-lg dark:bg-gray-800">
                                    <!-- Modal body -->
                                    @php
                                        $myavatar = $user->usersignimage;
                                    @endphp
                                    <img class="h-auto max-w-xl rounded-lg shadow-xs dark:shadow-gray-800 mt-4" src="{{ asset("/storage/$myavatar") }}" alt="Signature" />
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        <!-- Middle Name -->
                                        <div class="col-span-2 sm:col-span-1">
                                            <div class="form-group mt-4">
                                                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="file_input">Upload file</label>
                                                <input class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" aria-describedby="file_input_help" id="usersignimage" name="usersignimage" type="file">
